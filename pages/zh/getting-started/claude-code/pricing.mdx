...
不是。合汇率不是银行汇率，也不是实时美元兑人民币汇率。它表示在套餐用满的情况下，用户每使用 1 USD 官方原价模型额度，折合需要多少人民币。
...
可能会。如发生倍率调整，我们会提前 3 天通知用户。

## 相关资源

- [获取 API Key](/zh/getting-started/claude-code/get-api-key)
- [安装和配置](/zh/getting-started/claude-code/installation)
- [常见问题](/zh/getting-started/claude-code/faq)
