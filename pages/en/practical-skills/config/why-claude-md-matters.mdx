...
<div style={{ textAlign: 'center', margin: '20px 0' }}>
  <img src="/images/discord-group-qrcode.svg" alt="Discord community QR code" width="200" />
  <p style={{ marginTop: '10px', color: '#666' }}>Join the <a href="https://discord.gg/VCdTwvYBJd" target="_blank">Discord community</a> to get the CLAUDE.md template</p>
</div>
